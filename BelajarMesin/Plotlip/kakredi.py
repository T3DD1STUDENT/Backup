...
Directory = "BelajarMesin/Plotlip/"
...
try:
    df = pd.read_csv(f"{Directory}/filmbaru2050.csv" )
...
df['Total_Penjualan_Bulanan'] = df[['GogOPOWERANGER', 'Woolkong', 'Averager', 'Princesrubansel','Doctornormal', 'Whirelies']].sum(axis=1)
